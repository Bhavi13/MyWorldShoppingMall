...
<body>
	<% ArrayList<UserOrder> userOrderList = (ArrayList<UserOrder>) request.getAttribute("userOrderArrayList"); %>
						...
						<fieldset>
							...
							<table class="table table-striped table-hover ">
								...
								<tbody>
									...
									%>
									<tr>
										<td><%=userOrderList.get(i).getItemName()%></td>
										<td><%=userOrderList.get(i).getItemDesc()%></td>
										<td><%=userOrderList.get(i).getCategory()%></td>
										<td><%=userOrderList.get(i).getShopName()%></td>
										<td><%=userOrderList.get(i).getShopCategory()%></td>
										<td><a
											href="/MyWorldShoppingMall/SignUpServlet?action=getItemDetails&userOrderId=<%=userOrderList.get(i).getOrderId()%>">Write
												a Review</a></td>
									</tr>
