							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="radio" name="gender" id="genderM" value="Male"
										...
										name="gender" id="genderM" value="Female">Female <label
										style="color: red">*</label>
								</div>
							</div>
							<div class="form-group">
							...
							<table class="table table-striped table-hover ">
								<tr>
									<td><label for="oldPassword"
										class="col-lg-7 control-label">Old Password</label></td>
									<td><input type="password" class="form-control"
										id="oldPassword" name="oldPassword" placeholder="Old Password"></td>
								</tr>
								<tr>
									<td><label for="newPassword"
										class="col-lg-7 control-label">New Password</label></td>
									<td><input type="password" class="form-control"
										id="newPassword" name="newPassword" placeholder="New Password"></td>
								</tr>
								<tr>
									<td><label for="confPassword"
										class="col-lg-7 control-label">Confirm Password</label></td>
									<td><input type="password" class="form-control"
